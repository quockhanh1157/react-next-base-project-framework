...
const Feature = ({ slice }: FeatureProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="grid mobile:grid-cols-1 tablet:grid-cols-2 desktop:grid-cols-4 max-w-5xl gap-x-8 gap-y-12 mx-auto desktop:place-items-start place-items-center">
